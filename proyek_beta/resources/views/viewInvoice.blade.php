...
@section('content')
    <div class="container d-flex justify-content-center" style="width : 100%;min-height: 450px; padding-top:100px;">
        <div class="text-center pt-4" style="border:1px solid black; padding:15px 20px;width:40% ;height:300px">
            <h2>Invoice</h2>
