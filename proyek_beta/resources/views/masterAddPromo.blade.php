        ...
        <form action="/admin/master/promo/add" method="post" class="mt-3 pb-3" enctype="multipart/form-data">
            ...
            <table class="w-100">
              ...
              <tr>
                <td>Kode Promo:</td>
                <td>
                  <input required value="{{ old('kodePromo') }}" id="kodePromo" class=" form-control @error('kodePromo') is-invalid @enderror" type="text" name="kodePromo" size="50" placeholder="Kode Promo" id="">
                  @error('kodePromo')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
